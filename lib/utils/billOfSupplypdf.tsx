...
// ── Component ─────────────────────────────────────────────────────────────────
const BillOfSupplyPDF = forwardRef<BillOfSupplyHandle, BillOfSupplyProps>(function BillOfSupplyPDF(
  {
    branch = DEMO_BRANCH,
      ...
      <div ref={printRef} style={{ background: "#fff" }}>
        ...
        <div style={{ ...BASE, position: "relative", maxWidth: "720px", margin: "50px auto", padding: "0 20px 40px" }}>
          ...
          {/* <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "11px", marginTop: "10px" }}>
            <thead>
              <tr>
                {["HSN/SAC", "Taxable Value", "CGST Rate", "CGST Amount", "SGST/UTGST Rate", "SGST/UTGST Amount", "Total Tax"].map((h,i) => (
                  <th key={h} style={{ border: "1px solid #000", padding: "10px", textAlign: "center", borderRight: [0, 1, 2, 3,4, 5].includes(i) ? "none" : "1px solid #000", borderBottom: [0, 1, 2, 3, 4, 5,6].includes(i) ? "none" : "1px solid #000"  }}>{h}</th>
                ))}
              </tr>
            </thead>
            <tbody>
...
BillOfSupplyPDF.displayName = "BillOfSupplyPDF";

export default BillOfSupplyPDF;
