...
import { FaCrown, FaTelegramPlane, FaWhatsapp, FaHeadset } from "react-icons/fa";

// ─── Data Types for User Support Hub ──────────────────────────────────────────
...
// ─── Mock Support Tickets for User Portal ─────────────────────────────────────
const MOCK_USER_SUPPORT_TICKETS: UserSupportTicket[] = [
  {
    id: "TICK-8921",
    ...
    messages: [
      {
        id: "m1",
        sender: "User",
        senderName: "You (Sunil Reddy)",
        message: "Hello support team, I submitted a withdrawal request of $1,450 to my USDT TRC20 wallet TX9z...kP3a9. Please confirm expected transfer completion.",
        timestamp: "2026-08-11 10:30 AM",
      },
      {
        id: "m2",
        sender: "VIP Support Specialist",
        senderName: "Alex - VIP Concierge Specialist",
        message: "Hello Sunil! Your withdrawal request of $1,450 is currently being verified by finance. It will be dispatched within 15-30 minutes.",
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: "m2",
        sender: "VIP Support Specialist",
        senderName: "Sarah - Helpdesk Specialist",
        message: "Hello Sunil! Yes, daily ROI interest of $22.00 (+2.2%) is automatically credited to your withdrawable balance every 24 hours from purchase time.",
...
// ─── Searchable FAQ Knowledge Base Data ──────────────────────────────────────
const FAQ_ITEMS = [
  {
...
export default function UserSupportPage() {
  // Ticket & Filter State
  const [tickets, setTickets] = useState<UserSupportTicket[]>(MOCK_USER_SUPPORT_TICKETS);
  ...
  const [newCategory, setNewCategory] = useState<UserSupportTicket["category"]>("Withdrawal / Deposit");
  ...
  const handleCreateTicket = (e: React.FormEvent) => {
    ...
    const createdTicket: UserSupportTicket = {
  ...
  return (
    <AppShell>
      ...
      <div className="space-y-6">
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="px-2.5 py-0.5 rounded-md bg-amber-100 text-amber-950 font-black text-xs uppercase tracking-wider flex items-center gap-1">
                <FaHeadset className="text-amber-600" /> 24/7 VIP Helpdesk
              </span>
            </div>
            <PageHeading title="VIP Support & Live Helpdesk" />
            <p className="text-xs text-slate-500 mt-1">
              Connect with 24/7 VIP Concierge Support, submit helpdesk tickets, and track withdrawal and ROI interest inquiries.
            </p>
          </div>
        ...
        <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-amber-950 rounded-2xl p-6 shadow-xl border border-slate-700 text-white relative overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-6">
            <div>
              ...
              <h2 className="text-2xl font-black text-white mt-2">How Can We Assist You Today?</h2>
              <p className="text-xs text-slate-300 font-medium mt-0.5 max-w-2xl">
                Our support team is online 24 hours a day to assist with crypto USDT payouts, bank withdrawals, daily ROI interest, and level rewards.
              </p>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
            <div className="p-3 bg-slate-800/80 rounded-xl border border-slate-700">
              <span className="text-[10px] font-bold text-slate-400 uppercase block">Avg. Response Time</span>
            ...
            <div className="p-3 bg-slate-800/80 rounded-xl border border-slate-700">
              ...
              <span className="text-lg font-black text-emerald-400 mt-0.5 block flex items-center gap-1">
                <FiCheckCircle /> 99.8% Resolved
              </span>
            </div>
            <div className="p-3 bg-slate-800/80 rounded-xl border border-slate-700">
              <span className="text-[10px] font-bold text-slate-400 uppercase block">VIP Concierge</span>
              <span className="text-lg font-black text-white mt-0.5 block flex items-center gap-1">
                <FaCrown className="text-amber-400" /> 24/7 Active
              </span>
            </div>
            <div className="p-3 bg-slate-800/80 rounded-xl border border-slate-700">
        ...
        {/* 4 VIP SUPPORT ACTION CHANNELS */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {/* Channel 1: 24/7 Live Chat */}
          <div className="bg-white rounded-2xl p-5 shadow-md border border-slate-200 hover:border-amber-400 transition-all flex flex-col justify-between group">
            <div>
              ...
              <p className="text-xs text-slate-500 font-medium mt-1">Connect with support specialists in real time.</p>
            </div>
            <button
              type="button"
              onClick={() => showToast("Connecting to 24/7 Live Chat Concierge...")}
          ...
          <div className="bg-white rounded-2xl p-5 shadow-md border border-slate-200 hover:border-blue-400 transition-all flex flex-col justify-between group">
            <div>
              ...
              <h3 className="font-extrabold text-slate-900 text-base">Official Telegram Channel</h3>
              <p className="text-xs text-slate-500 font-medium mt-1">Join 45,000+ members for daily yield updates & community perks.</p>
            </div>
            <button
              type="button"
              onClick={() => showToast("Opening Official Telegram VIP Channel...")}
            ...
            >
              <FaTelegramPlane className="text-white" /> Join Telegram Channel
            </button>
          </div>

          {/* Channel 3: WhatsApp VIP Concierge */}
          <div className="bg-white rounded-2xl p-5 shadow-md border border-slate-200 hover:border-emerald-400 transition-all flex flex-col justify-between group">
            <div>
              ...
              <h3 className="font-extrabold text-slate-900 text-base">VIP WhatsApp Manager</h3>
              <p className="text-xs text-slate-500 font-medium mt-1">Dedicated 1-on-1 manager for Gold Shareholder & VIP members.</p>
            </div>
            <button
              type="button"
              onClick={() => showToast("Connecting to WhatsApp VIP Manager...")}
            ...
            >
              <FaWhatsapp className="text-white" /> WhatsApp VIP
            </button>
          </div>

          {/* Channel 4: Submit Support Ticket */}
          <div className="bg-white rounded-2xl p-5 shadow-md border border-slate-200 hover:border-indigo-400 transition-all flex flex-col justify-between group">
            <div>
              ...
              <h3 className="font-extrabold text-slate-900 text-base">Ticket Helpdesk</h3>
              <p className="text-xs text-slate-500 font-medium mt-1">Submit technical or payout inquiry support tickets.</p>
            </div>
            <button
              type="button"
              onClick={() => setIsCreateDialogOpen(true)}
              className="mt-4 px-4 py-2 bg-slate-900 hover:bg-slate-800 text-amber-400 font-black text-xs rounded-xl transition-colors shadow flex items-center justify-center gap-2"
            >
              <FiPlusCircle className="text-amber-400" /> Create Ticket
            </button>
          </div>
        </div>

        {/* TICKET HISTORY LOG TABLE */}
        <div className="bg-white rounded-2xl p-6 shadow-md border border-slate-200 space-y-4">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-slate-200 pb-4">
            <div>
              <h3 className="font-bold text-lg text-slate-900 flex items-center gap-2">
                <FiMessageSquare className="text-amber-500" /> Your Support Tickets ({tickets.length})
              </h3>
              <p className="text-xs text-slate-500 mt-0.5">Track responses to your support inquiries.</p>
            </div>
        ...
        {/* SEARCHABLE FAQ KNOWLEDGE BASE ACCORDION */}
        <div className="bg-white rounded-2xl p-6 shadow-md border border-slate-200 space-y-4">
          <div className="flex items-center justify-between border-b border-slate-200 pb-3">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">Quick answers to common questions about daily ROI, withdrawals, and level rewards.</p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            {FAQ_ITEMS.map((faq, index) => {
              ...
              return (
                <div key={index} className="rounded-xl border border-slate-200 overflow-hidden bg-slate-50 transition-all">
                  <button
                    type="button"
          ...
          <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 space-y-3">
            <div>
              <FormInputField
                ...
                placeholder="e.g. Withdrawal Payout Status Confirmation"
                height={42}
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div>
                ...
                <select
                  value={newCategory}
                  onChange={(e) => setNewCategory(e.target.value as UserSupportTicket["category"])}
      ...
      >
        {selectedTicket && (
          <div className="space-y-4 text-xs">
            ...
            <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 max-h-[300px] overflow-y-auto space-y-3">
            ...
            <form onSubmit={handleSendReply} className="space-y-3 pt-1">
              <FormTextareaField
                label="Reply to Support Specialist"
                value={replyMessage}
