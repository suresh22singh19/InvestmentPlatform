...
import { PatientTherapiesTab } from "@/components/ipd-head-nurse/therapies";
...
export default function IPDStaffNurseTherapiesPage() {
  ...
  } = useGetPatientTherapyScheduleListQuery(listParams!, {
                        ...
                        <Table className={therapies.length > 5 ? "max-h-[276px]" : ""}>
                          <TableHeader>
                            <TableRow className="bg-white">
                              ...
                              <TableHead position="last">Time Slot</TableHead>
