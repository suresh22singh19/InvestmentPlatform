...
import { useGetAllLeadsQuery, type LeadItem } from "@/store/api/leadsApi";
...
export default function LeadRequestPage() {
    ...
    const leadsQuerySkip =
        !canView ||
        (isBranchFilterSuperAdmin &&
            (hookFilterBranchId === undefined || !Number.isFinite(hookFilterBranchId) || hookFilterBranchId < 1));

    const { data, isFetching, isError, refetch } = useGetAllLeadsQuery(
        {
