...
export default function IPDHeadNurseMedicationPage() {
  ...
  } = useStaffNurseGetMedicationDashboardSummaryQuery(summaryParams!, {
  ...
  } = useStaffNurseGetPatientMedicationListQuery(listParams!, {
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm font-medium text-[#525763]">
             Shift overview • {formatShiftOverviewDate(selectedDate)}
            </p>
          </div>
