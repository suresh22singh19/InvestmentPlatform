...
export default function DoctorListPage() {
    ...
    const goView = (row: DoctorRecord) => router.push(`/settings/doctor/${row.id}`);
    const goCredentials = (row: DoctorRecord) =>
        router.push(`/settings/doctor/${row.id}?section=credentials`);
    const goEdit = (row: DoctorRecord) => router.push(`/settings/doctor/${row.id}/edit`);
