        ...
        return (
            <AppShell>
                <div className="space-y-8 pb-10">
                    ...
                    <BackToPreviousPageButton text="List" onClick={() => router.push("/settings/doctor")} />
                </div>
            </AppShell>
        );
    }
                ...
                <div className="space-y-8 pb-10">
                    ...
                    <div className="flex flex-wrap items-center justify-end gap-3">
                        <BackToPreviousPageButton
                            text="Back"
                            onClick={() => router.push(`/settings/doctor`)}
                        />
                        <Button
                            type="button"
                            variant="primary"
        ...
        <AppShell>
            <div className="space-y-8 pb-10">
                ...
                <div className="flex justify-end">
                    <BackToPreviousPageButton text="Back" onClick={() => router.push("/settings/doctor")} />
                </div>
            </div>
        </AppShell>
    );
