...
function formatTherapyScheduleTime(session: PatientTherapyScheduleItem) {
  const start = session.scheduledStartTime || session.startTime || session.sessionStartTime;
...
function TherapyScheduleCardView({
  ...
  return (
    <div
      ...
      // className="w-[270px] flex-1 rounded-[10px] border px-3 py-3 shadow-[0px_1px_2px_rgba(15,23,42,0.04)]"
