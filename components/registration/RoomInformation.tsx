        ...
        <div className="mb-4 w-full overflow-hidden rounded-[20px] border border-[#E3EEE1] bg-white px-6 pb-6 pt-5 shadow-[0px_20px_40px_rgba(34,56,43,0.08)]">
            ...
            >
                <div className="flex items-center gap-2 ">
                    <Image src="/icons/roominfo.svg" alt="Room Info Icon" width={22} height={22} />
                    <h2 className="font-inter font-medium text-base leading-[120%] text-[#262D3B]">Room Information</h2>
                </div>
                <svg
                    width="20"
                    height="20"
