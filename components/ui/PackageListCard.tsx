      ...
      {showActionButtons ? (
        ...
        <div className="-mx-5 flex items-center px-5 pt-5">
          <button
            type="button"
            onClick={() => onView?.(pkg)}
            className="cursor-pointer flex h-[30px] flex-1 items-center justify-center gap-2 rounded-[32px] bg-[#0B8C00] px-4 text-xs font-medium leading-[120%] text-white transition-colors hover:bg-[#0A7F00]"
          >
