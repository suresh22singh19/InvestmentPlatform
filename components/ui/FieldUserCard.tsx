      ...
      <div className="mb-5 grid grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="mt-0.5 text-sm font-medium leading-[120%] text-[#262D3B]">{phone}</p>
          </div>
          <div>
            <p className="text-xs leading-[120%] text-[#7B8089]">Username</p>
            <p className="mt-0.5 text-sm font-medium leading-[120%] text-[#262D3B]">{username}</p>
          </div>
          <div>
            <p className="text-xs leading-[120%] text-[#7B8089]">Group</p>
            <p className="mt-0.5 text-sm font-medium leading-[120%] text-[#262D3B]">{group}</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            <p className="text-xs leading-[120%] text-[#7B8089]">Manager</p>
            <p className="mt-0.5 text-sm font-medium leading-[120%] text-[#262D3B]">{manager}</p>
          </div>
          <div>
